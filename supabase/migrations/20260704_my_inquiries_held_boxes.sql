-- Expose held_boxes (summed inquiry_items.held_qty) on each order in my_inquiries,
-- so the stockist order card can show how many boxes are currently held.
...
as $function$
  ...
  from (
    select jsonb_build_object(
      ...
      -- Held boxes on this order (H_Quantity), summed across its held lines.
