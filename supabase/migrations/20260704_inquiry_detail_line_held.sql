-- Add per-line 'line_held' (inquiry_items.held_qty) to inquiry_detail lines so the
-- stockist "Hold selected quantities" sheet can pre-fill each design's held amount.
