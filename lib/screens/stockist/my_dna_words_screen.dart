          ...
          : Column(
              children: [
                Container(
                  ...
                  child: const Text(
                    'Add YOUR words for each value (e.g. for "Sugar" type '
                    '"Raindrop"). Separate with comma, semicolon or new line. '
                    'Buyers see your words; search still groups everyone under '
                    'the admin value.',
