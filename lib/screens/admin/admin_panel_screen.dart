    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _adminCard(Icons.list_alt_outlined, 'Managed Lists',
              'Shared pick-lists — Space, Placement (media portfolio)',
              const Color(0xFF00897B),
              onTap: () => context.push('/admin/managed-lists')),
          ...
          _adminCard(Icons.play_circle_outline, 'Banner Video',
              'Learning videos + each stockist’s video mode',
              const Color(0xFFC2185B),
              onTap: () => context.push('/admin/banner-video')),
